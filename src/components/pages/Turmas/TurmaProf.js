...
import { getDocumentoUnico, filtro, getDocCollection } from "../../../firebase/CRUD"
import { FichaAluno } from "../../layout/Fichas"
import { useParams } from "react-router-dom"
import BackButton from '../../layout/BackButton'
import { useAuth } from "../../../hooks/AuthContext"

export default function TurmasProf(){
    ...
    useEffect(()=>{
        ...
        getDocCollection('professores',setAlunos,usuario.idEscola)
